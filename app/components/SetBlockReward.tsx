...
export default function SetBlockRewards() {
    ...
    return(
        <form onSubmit={submit} className="w-full flex flex-col w-3/5  bg-gradient-to-r h-min from-gray-800 via-gray-900 to-black text-white rounded-xl shadow-lg p-6 space-y-6">
            <h2 className="text-xl font-semibold text-purple-400 text-center">Set Block Rewards</h2>
            ...
            <div className="flex flex-col">
                ...
                >
                    {isPending ? 'Confirming...' : 'Set block reward'}
                </button>
                ...
                {isConfirmed && (
                    <div className="text-green-400 mt-2 text-center">Transaction confirmed! New BlockRewards are set!</div>
                )}
