...
export default function TokenDetails() {
    ...
    return (
        <div className="flex flex-col items-center p-6 bg-gradient-to-r from-gray-900 to-gray-700 text-white rounded-xl shadow-lg space-y-6 w-full scale-[0.9] md:scale-[0.97] md:w-1/2 max-w-lg mx-auto">
