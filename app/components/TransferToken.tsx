...
export default function TransferButton() {
    ...
    return (
        <form onSubmit={submit} className="flex flex-col  bg-gradient-to-r h-min from-gray-800 via-gray-900 to-black text-white rounded-xl shadow-lg p-6 space-y-6">
            <h2 className="text-xl font-semibold text-purple-400 text-center">Transfer NBL Tokens</h2>
            ...
            <div className="flex flex-col space-y-4">
                ...
                >
                    {isPending ? 'Confirming...' : 'Transfer NBL'}
                </button>
